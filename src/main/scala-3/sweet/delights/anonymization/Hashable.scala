...
object Hashable {
  ...
  given bytesWithMD5: Hashable[Array[Byte], Hash.MD5.type] = (t: Array[Byte]) => hashArray(Hash.MD5.name)(t)
  given bytesWithSHA1: Hashable[Array[Byte], Hash.SHA1.type] = (t: Array[Byte]) => hashArray(Hash.SHA1.name)(t)
  given bytesWithSHA256: Hashable[Array[Byte], Hash.SHA256.type] = (t: Array[Byte]) => hashArray(Hash.SHA256.name)(t)
  given bytesWithSHA384: Hashable[Array[Byte], Hash.SHA384.type] = (t: Array[Byte]) => hashArray(Hash.SHA384.name)(t)
  given bytesWithSHA512: Hashable[Array[Byte], Hash.SHA512.type] = (t: Array[Byte]) => hashArray(Hash.SHA512.name)(t)

  // hash third-party type T by transforming T into a hashable type U with hashing H
  given usingInjection[T, U, H <: Hash](using injection: Injection[T, U], hashable: Hashable[U, H]): Hashable[T, H] = { (t: T) =>
  ...
  given optionWithAnyHash[T, H <: Hash](using hashable: Hashable[T, H]): Hashable[Option[T], H] =
    (t: Option[T]) => t.map(hashable.hash)

  given listWithAnyHash[T, H <: Hash](using hashable: Hashable[T, H]): Hashable[List[T], H] =
